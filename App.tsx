...
import { Wizard } from './components/Wizard'; // Importamos o Wizard
import { SongSample, FaqItem } from './types';

// NOTA: Removemos a importação do "Planos" porque vamos desenhar o cartão vermelho diretamente aqui
    ...
    <div className="min-h-screen bg-white font-sans text-gray-900 selection:bg-brand-100 selection:text-brand-900">
      ...
      <header className="fixed top-0 w-full z-50 bg-white/90 backdrop-blur-md border-b border-brand-100 shadow-sm">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <button 
            onClick={scrollToPricing} // Botão do header leva ao cartão vermelho
      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-72 h-72 bg-pink-100 rounded-full blur-3xl opacity-50 z-0"></div>

        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
            <div className="flex-1 text-center md:text-left space-y-6">
              <div className="inline-flex items-center gap-2 bg-red-50 text-brand-600 px-3 py-1 rounded-full text-sm font-semibold border border-red-100">
              ...
              <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-xl mx-auto md:mx-0">
                Surpreende a tua cara-metade com uma música personalizada feita à vossa medida. Entrega em 24h para que o Dia dos Namorados seja inesquecível.
              </p>
              
              <div className="flex flex-col sm:flex-row items-center gap-4 justify-center md:justify-start pt-4">
                {/* Botão Hero leva ao Wizard */}
            ...
            <div className="flex-1 relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl transform md:rotate-2 hover:rotate-0 transition-transform duration-500">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-8">
                  <div className="bg-white/95 backdrop-blur rounded-xl p-4 flex items-center gap-4 max-w-xs shadow-lg transform translate-y-4 md:translate-y-0">
                    <div className="bg-brand-100 p-3 rounded-full text-brand-600">
                      <Music size={24} />
                    </div>
                    <div>
                      <p className="font-bold text-sm text-gray-900">A Nossa História</p>
                      <p className="text-xs text-gray-500">Música Personalizada • 03:42</p>
                    </div>
                    <div className="ml-auto">
                       <div className="w-6 h-6 flex items-center justify-center rounded-full bg-brand-500 text-white">
      ...
      {/* PRICING SECTION - CARTÃO VERMELHO RESTAURADO */}
