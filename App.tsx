...
export const Wizard: React.FC<WizardProps> = ({ onBack }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    extraDetails: '',  
    style: '',
    deliveryOption: '24h' // NOVO PADRÃO: 24 Horas
  });

  // CÁLCULO DO PREÇO (24.99€ Base | 29.98€ Upsell 12h)
  ...
  const handleStripe = () => {
    ...
    // --- LINKS DE PAGAMENTO FINAIS (URGÊNCIA) ---
    ...
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-xl space-y-6">
        ...
        <div className="space-y-3">
          ...
          {/* OPÇÃO 2: AGORA É 12 HORAS (PREÇO EXTRA +4.99€) */}
          <div 
      ...
      <div className="text-center space-y-8 py-10 animate-fadeIn px-4">
        ...
        <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 shadow-sm">
           ...
           <p className="text-2xl font-bold text-slate-900 mb-6">
              {formData.deliveryOption === '12h' ? 'Dentro de 12 Horas' : 'Dentro de 24 Horas'}
           </p>
