...
// Certifica-te que os ficheiros na pasta 'src/assets' têm estes nomes exatos:
import teddyAudio from '../assets/teddy.mp3';     
...
// --- CONFIGURAÇÃO DOS ESTILOS (DESCRIÇÕES ATUALIZADAS) ---
const MUSIC_STYLES = [
  { 
    id: 'soul', 
    name: 'Alma & Emoção', 
