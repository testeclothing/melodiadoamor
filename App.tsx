...
export const Wizard: React.FC<WizardProps> = ({ onBack }) => {
  ...
  // ESTADO DO FORMULÁRIO (Volta ao padrão 72h)
  const [formData, setFormData] = useState({
    ...
    extraDetails: '',  
    style: '',
    deliveryOption: '72h' // Padrão normal
  });
  ...
  const handleStripe = () => {
    ...
    const L_NORMAL = "https://buy.stripe.com/4gM28tfFCgtX6f8bZn6c001"; // 24.99€
    const L_PRIORITY = "https://buy.stripe.com/aFabJ33WU3Hbbzs8Nb6c000"; // 34.98€
  ...
  const renderStep4 = () => (
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-xl space-y-6">
        ...
        {/* SELEÇÃO DE ENTREGA (EVERGREEN - NORMAL 72H) */}
      ...
      <div className="text-center space-y-8 py-10 animate-fadeIn px-4">
        ...
        <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 shadow-sm">
           ...
           <p className="text-2xl font-bold text-slate-900 mb-6">
              {formData.deliveryOption === '24h' ? 'Menos de 24 Horas' : 'Até 72 Horas'}
           </p>
