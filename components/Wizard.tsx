...
export const Wizard: React.FC<WizardProps> = ({ onBack }) => {
  ...
  const renderStep1 = () => (
    <div className="space-y-6 animate-fadeIn">
      <div className="text-center md:text-left">
        ...
        <p className="text-slate-500 text-sm mt-1">Quem oferece e quem recebe este presente?</p>
      </div>
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
                <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1 flex items-center gap-1">
                    <Heart size={12} className="text-rose-500" /> Para Quem (Nome Dele/a)
                </label>
                <input 
                    type="text" 
                    className="w-full p-4 border border-slate-200 rounded-xl focus:ring-2 focus:ring-rose-500 outline-none transition-all font-medium"
  ...
  const renderStep4 = () => (
    <div className="space-y-6 animate-fadeIn">
      ...
      {/* Botão de Pagamento continua escuro para destaque, mas pode ser alterado se preferir */}
  ...
  const renderStep5 = () => (
    <div className="text-center space-y-8 py-12 animate-fadeIn">
      ...
      {/* Cartão de Sucesso agora em Modo Claro */}
      <div className="bg-slate-50 border border-slate-100 text-slate-900 p-8 rounded-[2rem] shadow-xl">
         ...
         <p className="text-xs uppercase tracking-[0.3em] opacity-40 mb-2 font-black text-slate-500">Entrega Estimada</p>
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 font-sans selection:bg-rose-100">
      <div className="bg-white w-full max-w-lg rounded-[2.5rem] shadow-[0_30px_100px_rgba(0,0,0,0.1)] overflow-hidden border border-slate-100 relative">
        {step < 5 && (
          // Header agora em Modo Claro
          <div className="bg-white border-b border-slate-100 p-5 flex items-center text-slate-800">
